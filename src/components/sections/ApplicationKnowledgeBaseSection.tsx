          ...
          <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              {knowledgeStats.map((stat, index) => (
                ...
                >
                  <div className={`inline-flex items-center justify-center w-16 h-16 ${stat.bgColor} rounded-full mb-3`}>
          ...
          >
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">🎯 New Joiner Onboarding Impact</h2>
              </div>
                ...
                >
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-800 font-medium text-sm">{impact.impact}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Onboarding Time Comparison</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-gray-600 text-sm">Average time to productivity</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600 text-sm">40% faster onboarding</div>
                  <div className="mt-4 space-y-2 text-sm text-gray-600">
                    <div className="flex items-center justify-center space-x-2">
