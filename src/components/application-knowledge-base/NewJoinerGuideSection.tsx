  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {onboardingMetrics.map((metric, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{metric.label}</h3>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
              ...
              <button
                ...
                className={`flex-shrink-0 flex items-center space-x-3 px-6 py-3 rounded-lg border-2 transition-all ${
                  activePhase === phase.phase
                    ...
                    : 'border-gray-200 dark:border-white/[0.06] hover:border-gray-300 dark:hover:border-white/[0.12] text-gray-600 dark:text-gray-400'
                }`}
              >
                ...
                <div className="p-8">
                  <div className="space-y-8">
                    {phase.modules.map((module, moduleIndex) => (
                      <div key={moduleIndex} className="bg-gray-50 dark:bg-white/[0.03] rounded-xl p-6 border border-gray-200 dark:border-white/[0.06]">
                        {/* Module Header */}
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="text-xl font-semibold text-gray-900 dark:text-white">{module.title}</h4>
                        ...
                        <div className="space-y-6">
                          ...
                          {'aiInsights' in module && (
                            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 rounded-lg p-4">
                              ...
                              <p className="text-blue-800 dark:text-blue-300 text-sm">{module.aiInsights}</p>
                            </div>
                          )}
                            ...
                            <div>
                              ...
                              <ul className="space-y-2">
                                {module.practicalExercises.map((exercise, exerciseIndex) => (
                                  <li key={exerciseIndex} className="flex items-start space-x-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <div>
                              ...
                              <ul className="space-y-2">
                                {module.successMetrics.map((metric, metricIndex) => (
                                  <li key={metricIndex} className="flex items-start space-x-2 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <div>
                            ...
                            <ul className="space-y-2">
                              {module.resources.map((resource, resourceIndex) => (
                                <li key={resourceIndex} className="flex items-start space-x-2 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="space-y-8">
          {/* Progress Tracker */}
          <div className="bg-white dark:bg-[#1A1A1A] rounded-xl shadow-lg dark:shadow-none dark:border border-gray-100 dark:border-white/[0.06] p-6">
          ...
          <div className="bg-white dark:bg-[#1A1A1A] rounded-xl shadow-lg dark:shadow-none dark:border border-gray-100 dark:border-white/[0.06] p-6">
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-gray-900 dark:text-white">{knowledgeAssessment.title}</h4>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 rounded-lg p-3">
                ...
                <div className="text-sm text-green-800 dark:text-green-300">{knowledgeAssessment.recommendation}</div>
              </div>
            </div>
          </div>

          {/* Quick Stats */}
          <div className="bg-gradient-to-r from-blue-50 dark:from-blue-900/20 to-purple-50 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800/30">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Quick Stats</h3>

            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Time Saved vs Traditional:</span>
                <span className="font-medium text-green-600 dark:text-green-400">2 weeks</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Cost Saving per Hire:</span>
                <span className="font-medium text-blue-600 dark:text-blue-400">$8,000</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Knowledge Retention:</span>
                <span className="font-medium text-purple-600 dark:text-purple-400">85%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Defect Reduction:</span>
                <span className="font-medium text-orange-600 dark:text-orange-400">60%</span>
              </div>
            </div>
          </div>
        </div>
