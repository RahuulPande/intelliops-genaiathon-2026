              ...
              <div key={day.day} className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs text-blue-600 font-medium">{day.searches}</span>
                  </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs text-purple-600 font-medium">{day.views}</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center p-6 bg-blue-50 rounded-xl">
            ...
            <div className="text-2xl font-bold text-blue-600 mb-1">{usageAnalytics.weeklyUpdates}</div>
            <div className="text-sm text-gray-600">Weekly knowledge updates</div>
            <div className="text-xs text-blue-500 mt-1">New insights added</div>
          </div>
          
          <div className="text-center p-6 bg-green-50 rounded-xl">
            <Star className="w-8 h-8 text-green-600 mx-auto mb-3" />
            <div className="text-2xl font-bold text-green-600 mb-1">{usageAnalytics.userRating}/5</div>
            <div className="text-sm text-gray-600">User feedback rating</div>
            <div className="text-xs text-green-500 mt-1">Average satisfaction</div>
          </div>
          
          <div className="text-center p-6 bg-purple-50 rounded-xl">
            <CheckCircle className="w-8 h-8 text-purple-600 mx-auto mb-3" />
            <div className="text-2xl font-bold text-purple-600 mb-1">{usageAnalytics.accuracyRate}%</div>
            <div className="text-sm text-gray-600">Knowledge accuracy</div>
            <div className="text-xs text-purple-500 mt-1">Verified correct</div>
          </div>
          
          <div className="text-center p-6 bg-orange-50 rounded-xl">
            <BookOpen className="w-8 h-8 text-orange-600 mx-auto mb-3" />
            <div className="text-2xl font-bold text-orange-600 mb-1">{usageAnalytics.modulesCovered}%</div>
            <div className="text-sm text-gray-600">Coverage completeness</div>
            <div className="text-xs text-orange-500 mt-1">Modules documented</div>
          </div>
        </div>
      </motion.div>
