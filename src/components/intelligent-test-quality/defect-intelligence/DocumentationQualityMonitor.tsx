    ...
    <div className="p-6 space-y-6">
      ...
      >
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900">AI Learning Impact Analysis</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-medium text-gray-900 mb-3">Documentation Quality Distribution</h4>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Well Documented</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Critically Poor</span>
                <span className="text-sm font-medium text-red-600">{learningMetrics.criticallyPoor} defects</span>
              </div>
            </div>
          </div>
          <div>
            <h4 className="font-medium text-gray-900 mb-3">AI Learning Potential</h4>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Potential Accuracy</span>
                <span className="text-sm font-medium text-green-600">{learningMetrics.potentialAccuracy}%</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Improvement Opportunity</span>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <h4 className="text-lg font-medium text-gray-900 mb-2">{issue.defectTitle}</h4>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                ...
                <p className="text-red-700 text-sm italic">"{issue.currentDocumentation}"</p>
              </div>
                  ...
                  {issue.missingElements.map((element, elemIndex) => (
                    ...
                    >
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="font-medium text-sm text-gray-900">{element.element}</span>
                      </div>
                      <p className="text-xs text-gray-600">{element.impact}</p>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  {issue.aiSuggestions.map((suggestion, suggIndex) => (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <div className="font-medium text-blue-800 text-sm mb-1">{suggestion.category}:</div>
                          <p className="text-blue-700 text-sm mb-2">{suggestion.suggestion}</p>
                          <div className="text-xs text-blue-600 font-medium">{suggestion.potentialImpact}</div>
                        </div>
                      </div>
                    </div>
                  ))}
      ...
      >
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900">AI Learning Enhancement Opportunities</h3>
        </div>
            ...
            <div className="space-y-3">
              <div className="bg-white rounded-lg p-3 border border-green-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">DEF-2845</span>
                  <span className="text-xs text-green-600 font-medium">+15% matching accuracy</span>
                </div>
                <p className="text-sm text-gray-700">Add specific error codes and stack traces to generic error documentation</p>
              </div>
              <div className="bg-white rounded-lg p-3 border border-green-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">DEF-2846</span>
                  <span className="text-xs text-green-600 font-medium">+25% performance detection</span>
                </div>
                <p className="text-sm text-gray-700">Include response times and resource usage data for performance issues</p>
              </div>
            </div>
          </div>
          
          <div>
            <h4 className="font-medium text-gray-900 mb-3">Impact Projection</h4>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Time Savings per Defect</span>
