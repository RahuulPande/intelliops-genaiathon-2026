...
export default function AIDocumentationAssistant() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white dark:bg-[#1A1A1A] rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-800 p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Select Enhancement Opportunity</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {enhancementOpportunities.map((opportunity) => (
            ...
            >
              ...
              <h4 className="font-medium text-gray-900 dark:text-white mb-1">{opportunity.defectTitle}</h4>
      ...
      <motion.div
        ...
        className="bg-white dark:bg-[#1A1A1A] rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-800"
      >
        <div className="p-6 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{currentOpportunity.defectTitle}</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">{currentOpportunity.defectId}</p>
            </div>
            <div className="text-right">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400">{currentOpportunity.estimatedTimeToImplement} to implement</div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900 rounded-lg p-3 mb-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-blue-800 dark:text-blue-200">Business Value:</span>
              <span className="text-sm text-blue-700 dark:text-blue-200">{currentOpportunity.businessValue}</span>
            </div>
          </div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900 rounded-lg p-4">
            ...
            <p className="text-red-700 dark:text-red-200 text-sm italic">"{currentOpportunity.currentDocumentation}"</p>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-4 text-left hover:bg-gray-50 dark:hover:bg-[#242424] transition-colors"
                  >
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            ...
                            <span className="text-xs text-gray-500 dark:text-gray-400">{section.impact}</span>
                          </div>
                        </div>
                      </div>
                      <motion.div
                  ...
                  {isExpanded && (
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                      className="border-t border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-[#141414]"
                    >
                      <div className="space-y-4">
                        {/* Current Content */}
                        <div>
                          <h6 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Current Content:</h6>
                          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900 rounded p-3">
                            <p className="text-red-700 dark:text-red-200 text-sm italic">
                        ...
                        <div>
                          <h6 className="font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center">
                            <Sparkles className="w-4 h-4 text-purple-600 mr-1" />
                            AI-Enhanced Content:
                          </h6>
                          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-900 rounded p-3">
                            <p className="text-green-800 dark:text-green-200 text-sm">{section.suggestedContent}</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900 rounded p-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-medium text-blue-800 dark:text-blue-200">Impact:</span>
                            <span className="text-sm text-blue-700 dark:text-blue-200">{section.impact}</span>
                          </div>
                        </div>
                      </div>
                    </motion.div>
        ...
        {/* Enhancement Actions */}
        <div className="p-6 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#141414]">
