...
export default function TestManagementSection({ initialTab = 'test-execution' }: TestManagementSectionProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Streamlined Test Operations</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Live test execution monitoring</div>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Individual and team metrics</div>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Quality-driven test execution</div>
            </div>
          </div>
        </div>
      </motion.div>
